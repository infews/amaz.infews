...
describe CartController do
  ...
  describe '#add' do    
    ...
    it 'should create a new cart with this item if one does not exist in the session' do
      ...
      aws_response.should_receive(:cart_items).and_return(@create_cart_doc/'cart/cartitems/cartitem'.inject([]) {|a, i| a << i})
    ...
    it 'should add a new cart item to an existing cart' do
      ...
      aws_response.should_receive(:cart_items).and_return(@add_to_cart_doc/'cart/cartitems/cartitem'.inject([]) {|a, i| a << i})
    ...
    it 'should redirect to / if there is no ASIN in the params'
  ...
  describe '#update' do
    ...
    it 'should update the quantity of an existing cart item in a cart' do
      ...
      aws_response.should_receive(:cart_items).and_return(@modify_cart_doc/'cart/cartitems/cartitem'.inject([]) {|a, i| a << i})
  ...
  describe '#clear' do
    ...
    it 'should clear an existing cart at Amazon.com' do 
      ...
      aws_response.should_receive(:cart_items).and_return(@clear_cart_doc/'cart/cartitems/cartitem'.inject([]) {|a, i| a << i})
